...
from core.agent import BaseAgent, _clean_think_tags
    ...
    async def mutate_dna(self, dna: AgentDNA) -> AgentDNA:
        ...
        for attempt in range(max_retries):
            ...
            if response is not None:
                # Utilisation de la fonction utilitaire commune pour le nettoyage
                new_role_prompt = _clean_think_tags(response)
                
                # Vérification additionnelle pour les markdown fences
                if new_role_prompt.startswith("